...
arq1 = open('/home/tholleben/Desktop/Álgebra/Macaulay2/numBetti/'+str(var)+'vardeg'+str(rep)+'rep'+ring1,'r')
arq2 = open('/home/tholleben/Desktop/Álgebra/Macaulay2/numBetti/'+str(var)+'vardeg'+str(rep)+'rep'+ring2,'r')
arq3 = open('/home/tholleben/Desktop/Álgebra/Macaulay2/numBetti/'+str(var)+'vardeg'+str(rep)+'rep'+ring3,'r')
...
for deg in range(2,var):
    ...
    ax.legend()
    plt.savefig('/home/tholleben/Desktop/experiments/Number Betti Comp/'+ring1+ring2+ring3 +'/'+ str(var)+'var_'+str(deg)+'deg_'+str(rep)+'rep_'+ring1+ring2+ring3)
