...
arq = open('/home/tholleben/Desktop/Álgebra/Macaulay2/numBetti/'+str(var)+'vardeg'+str(rep)+'rep'+ring,'r')
yss = []
badyss = arq.read()
...
plt.legend()
plt.savefig('/home/tholleben/Desktop/experiments/Number Betti Tables ' + ring + '/'+str(var)+ '_var_'+'deg_'+str(rep)+'_'+ ring)
plt.show()
