...
arq = open('./Simulations/probBetti/'+str(var)+'var'+str(deg)+'degprob'+str(rep)+'rep'+rR+sS,'r')
...
plt.savefig("./Simulation_results/Prob_Betti_Tables/"+str(var) + "_var_" + str(deg) + "_deg_"+str(rep)+"_rep_prob_"+str(M+2)+"_beg_"+str(N+2)+"_end_"+ rR + sS + ".png" , dpi=300)
plt.show()
